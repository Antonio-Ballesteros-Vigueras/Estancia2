...
<head>
    ...
    <link rel="stylesheet" href="../VISTA/CSS/Catalogo_Dashbord.css">
...
<div class="filtros">
    ...
    <form action="" method="GET">
        ...
        <button type="button" onclick="location.href='Vista_Update_Producto.php'">Volver</button>
    </form>
</div>
...
<div class="catalogo">
    ...
    if (mysqli_num_rows($resultado) > 0) {
        while ($producto = mysqli_fetch_assoc($resultado)) {
            ...
            echo '<br><a href="../CONTROLADOR/Update_Producto.php?IDProducto=' . htmlspecialchars($producto['IDProducto']) . '"><img src="../VISTA/IMG/actualizar-icon.png" alt="Actualizar" width="40" height="40"><p>Editar Suple.</p></a>';
        
            echo '<a href="#" onclick="confirmarEliminacionProducto(' . htmlspecialchars($producto['IDProducto']) . ')"><img src="../VISTA/IMG/eliminar-icon.png" alt="Eliminar" width="40" height="40"><p>Eliminar Suple.</p></a>';
...
function confirmarEliminacionProducto(idProducto) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch("../CONTROLADOR/Delete_Producto.php?IDProducto=" + idProducto)
                .then(response => {
                    if (response.ok) {
                        Swal.fire(
                            'Eliminado',
