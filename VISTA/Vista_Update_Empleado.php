...
<head>
    ...
    <link rel="stylesheet" href="../VISTA/CSS/Editar_Empleados.css">
...
<section class="texto-filtros-container">
    ...
    <section class="filtros">
        ...
        <form action="" method="GET">
            ...
            <button type="button" onclick="location.href='Vista_Update_Empleado.php'">Volver</button>
        </form>
    </section>
</section>
...
<table class="table">
    ...
    ?>
            <tr>
                <th> <?php echo $rows['IDEmpleado']; ?> </th>
                ...
                <th> <?php echo $rows['Cargo']; ?> </th>
                <th> <?php echo $rows['CorreoElectronico']; ?> </th>
                <th> <?php echo $rows['TipoUsuario']; ?> </th>
                <th><a href="../CONTROLADOR/Update_Empleado.php?IDEmpleado=<?php echo $rows['IDEmpleado']?>"><img src="../VISTA/IMG/actualizar-icon.png" width="30" height="30"></a></th>
                <th><a href="#" onclick="confirmarEliminacion(<?php echo $rows['IDEmpleado']; ?>)"><img src="../VISTA/IMG/eliminar-icon.png" width="30" height="30"></a></th>
            </tr>
    <?php } ?>
</table>
...
function confirmarEliminacion(idEmpleado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch("../CONTROLADOR/Delete_Empleado.php?IDEmpleado=" + idEmpleado)
                .then(response => {
                    if (response.ok) {
                        Swal.fire(
                            'Eliminado',
