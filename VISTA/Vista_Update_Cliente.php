...
<head>
    ...
    <link rel="stylesheet" href="../VISTA/CSS/Editar_Cliente.css">
...
<section class="texto-filtros-container">
    ...
    <section class="filtros">
        ...
        <form action="" method="GET">
            ...
            <button type="button" onclick="location.href='Vista_Update_Cliente.php'">Volver</button>
        </form>
    </section>
</section>
...
<table class="table">
    ...
    ?>
            <tr>
                ...
                <th><a href="../CONTROLADOR/Update_Cliente.php?IDCliente=<?php echo $rows['IDCliente']?>"><img src="../VISTA/IMG/actualizar-icon.png" width="30" height="30"></a></th>
...
function confirmarEliminacion(idCliente) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch("../CONTROLADOR/Delete_Cliente.php?IDCliente=" + idCliente)
                .then(response => {
                    if (response.ok) {
                        Swal.fire(
                            'Eliminado',
