...
<head>
    ...
    <link rel="stylesheet" href="../VISTA/CSS/Crear_Producto.css">
...
<form method="POST" name="Formulario_Registrar_Producto" id="Formulario_Registrar_Producto" action="../CONTROLADOR/Create_Producto.php" enctype="multipart/form-data">
    <div>
        <label>
            Nombre *:
        </label>
