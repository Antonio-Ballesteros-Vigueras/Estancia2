...
<section class="reportes">
    ...
    <section class="botones-reportes">
        ...
        <div class="modal" id="modalTotalCotizacionesLotePorCliente" style="display: none;">
            <div class="modal-content">
                ...
                <br>
                <button type="button" onclick="cerrarModal('modalTotalCotizacionesLotePorCliente')">Cancelar</button>
            </div>
        </div>
...
<script>
    function mostrarModal() {
        document.getElementById('modalTotalCotizacionesLotePorCliente').style.display = 'flex';
    }
