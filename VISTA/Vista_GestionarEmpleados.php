...
<head>
    ...
    <link rel="stylesheet" href="../VISTA/CSS/Gestionar_Empleados.css">
...
<section class="contacto">
    ...
    <div class="contact-item social-media">
        <p>
            <a href="../VISTA/Vista_Create_Empleado.php">
                <img src="../VISTA/IMG/registrar-icon.png" alt="Instagram" class="social-icon"> <br>Registrar Empleados
            </a>
        </p>
    </div>
    <div class="contact-item social-media">
        <p>
            <a href="../VISTA/Vista_Update_Empleado.php">
                <img src="../VISTA/IMG/actualizar-icon.png" alt="Instagram" class="social-icon"> <br>Editar Empleados
            </a>
        </p>
    </div>
