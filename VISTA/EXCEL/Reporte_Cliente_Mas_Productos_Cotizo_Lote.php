...
header('Content-Disposition: attachment; filename="Reporte_Clientes_Mas_Productos_Lote_Cotizo_Ultimo_Mes.xls"');
...
// Título del reporte
echo "<tr>
        <td colspan='3' style='text-align:center; font-size:32px; font-weight:bold; background-color: #FF8C00; color: white;'>REPORTE DE CLIENTES QUE MAS COTIZARON Y QUE PRODUCTOS, EN EL ULTIMO MES POR LOTE</td>
      </tr>";
...
echo "<tr>
        ...
        <th style='background-color: #FFDAB9; color: black; font-size: 24px; font-weight: bold;'>TOTAL LOTES COTIZADOS</th>
      </tr>";
