...
header('Content-Disposition: attachment; filename="Reporte_Cotizaciones_Por_Cliente_Unidad.xls"');
...
// Título del reporte
echo "<tr>
        <td colspan='5' style='text-align:center; font-size:32px; font-weight:bold; background-color: #FF8C00; color: white;'>REPORTE DE COTIZACIONES POR UNIDAD POR CLIENTE - $mes/$anio</td>
      </tr>";
