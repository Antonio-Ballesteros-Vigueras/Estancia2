...
header('Content-Disposition: attachment; filename="Reporte_Clientes_Mas_Productos_Cotizo_Unidad.xls"');
...
// Título del reporte
echo "<tr>
        <td colspan='3' style='text-align:center; font-size:32px; font-weight:bold; background-color: #FF8C00; color: white;'>REPORTE DE CLIENTES QUE MAS COTIZARON POR UNIDAD Y QUE PRODUCTOS FUERON</td>
      </tr>";
