...
header('Content-Disposition: attachment; filename="Reporte_Cotizacion_Lote_' . $idCotizacion . '.xls"');
header('Pragma: no-cache');
header('Expires: 0');

// Consultar los datos de la maquila
$consulta = "SELECT * FROM CotizacionLote WHERE IDCotizacion = $idCotizacion";
...
echo "<tr>
        <td colspan='9' style='text-align:center; font-size:32px; font-weight:bold; background-color: #FF8C00; color: white;'>REPORTE DE COTIZACION POR LOTE SOLICITADA POR EL CLIENTE: $usuario</td>
      </tr>";
...
echo "<tr>
        ...
        <th style='background-color: #FFDAB9; color: black; font-size: 24px; font-weight: bold;'>Cantidad Lotes</th>
