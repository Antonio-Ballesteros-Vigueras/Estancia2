...
<head>
    ...
    <link rel="stylesheet" href="../VISTA/CSS/Crear_Empleado.css">
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="../VISTA/JS/Validaciones_Crear_Empleado.js" defer></script>
    </head>
<body>
...
<section class="login">
            ...
            <br><h2>Registra los datos del nuevo Empleado</h2>
<form method="POST" name="Formulario_Registrar_Empleado" id="Formulario_Registrar_Empleado" action="../CONTROLADOR/Create_Empleado.php" onsubmit="return validarRegistro()">
    <div>
        <label>
            Nombres *:
        </label>
    ...
    <div>                    
        <input type="submit" value="Registrar Empleado" name="Registrar_Empleado">                    
    </div> 
