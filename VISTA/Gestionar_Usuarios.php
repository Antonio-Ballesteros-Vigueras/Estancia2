...
<section class="contacto">
    ...
    <div class="contact-item social-media">
        <p>
            <a href="../VISTA/Vista_GestionarAdministradores.php">
                <img src="../VISTA/IMG/usuario-icon.png" alt="Instagram" class="social-icon"> <br>G. Administradores
            </a>
        </p>
    </div>
    <div class="contact-item social-media">
        <p>
            <a href="../VISTA/Vista_GestionarEmpleados.php">
                <img src="../VISTA/IMG/usuario-icon.png" alt="Instagram" class="social-icon"> <br>G. Empleados
            </a>
        </p>
    </div>
    <div class="contact-item social-media">
        <p>
            <a href="../VISTA/Vista_GestionarClientes.php">
                <img src="../VISTA/IMG/usuario-icon.png" alt="Instagram" class="social-icon"> <br>G. Clientes
            </a>
        </p>
    </div>
