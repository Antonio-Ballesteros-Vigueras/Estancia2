...
<form method="POST" name="Formulario_Actualizar_Producto" id="Formulario_Actualizar_Producto" action="../CONTROLADOR/Update_Producto_Empleado.php?IDProducto=<?php echo $_GET['IDProducto']; ?>" enctype="multipart/form-data">
    <div>
        <label>
            Nombre *:
        </label>
