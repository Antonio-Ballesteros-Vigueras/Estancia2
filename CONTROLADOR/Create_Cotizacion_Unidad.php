...
if (isset($_POST['Enviar_Cotizacion'])) {
    ...
    $sql = "INSERT INTO CotizacionUnidad(Tipo, IDProducto, Nombre, Cantidad, FechaDeCotizacion, IDCliente, Usuario, Estado) 
    ...
    if ($execute) {
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = 'Nueva Cotización de Producto';
            $mail->Body = "
                <h3>Detalles de la Cotización de Producto por Unidades:</h3>
...
<section class="texto">
    <h1>Cotizar Producto por Unidades</h1>
</section>
...
<form method="POST" name="Formulario_Registrar_Cotizacion_Unidad" id="Formulario_Registrar_Cotizacion_Unidad" action="../CONTROLADOR/Create_Cotizacion_Unidad.php?IDProducto=<?php echo $_GET['IDProducto']; ?>">
