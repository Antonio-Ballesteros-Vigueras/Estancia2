...
<?php
    if(isset($_GET['IDEmpleado'])){
        ...
        $SQL = "SELECT *FROM Empleados WHERE IDEmpleado=$ID_Empleado;";
    ...
    if(isset($_POST['Actualizar'])){
        ...
        $sql = "UPDATE Empleados SET Nombres='$nombres', ApellidoPaterno='$apellidoPaterno', ApellidoMaterno='$apellidoMaterno', FechaNacimiento='$fechaNacimiento', Telefono='$telefono', Cargo='$cargo' WHERE IDEmpleado=$IDEmpleado;";
...
<head>
    ...
    <link rel="stylesheet" href="../VISTA/CSS/Update_Empleado.css">
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="../VISTA/JS/Update_Empleado.js" defer></script>
    </head>
<body>
...
<section class="login">
            ...
            <br><h2>Actualiza los datos del Empleado</h2>
<form method="POST" name="Formulario_Actualizar_Empleado" id="Formulario_Actualizar_Empleado" action="../CONTROLADOR/Update_Empleado.php?IDEmpleado=<?php echo $_GET['IDEmpleado']; ?>" onsubmit="return validarRegistro()">
    <div>
        <label>
            Nombres *:
        </label>
